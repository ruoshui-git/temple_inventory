...
describe('inventory browse contracts', () => {
  const tree = [
    ...
    { name: 'unspecified', warehouse_name: 'A02 / 未指定', warehouse_type: 'Location', fallback_role: 'room_default', parent_warehouse: 'room', is_group: 0, lft: 3, rgt: 4, company: 'Temple' },
