...
</template><AttachmentList v-if="record" class="workspace-attachment-list" :attachments="record.attachments" :editable="!readonly" @upload="uploadAttachmentFiles" @remove="removeAttachmentFile" /></main></template>
