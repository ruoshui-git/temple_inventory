...
const route = useRoute(), router = useRouter(), item = ref<any>(), boot = ref<any>(), error = ref(''), chosen = ref(''), editing = ref(false), saving = ref(false)
...
<template>
  <section class="app-shell wide-shell">
    ...
    <template v-else-if="item">
      ...
      <AttachmentList :attachments="item.attachments" :editable="item.can_edit" :primary-url="item.image" @upload="uploadAttachments" @remove="removeFile" @set-primary="setPrimary" />
