...
<template>
  <section class="app-shell wide-shell">
    ...
    <template v-else-if="item">
      ...
      <AttachmentList :attachments="item.attachments" :editable="item.can_edit" :allow-primary-image="true" :primary-url="item.image" @upload="uploadAttachments" @remove="removeFile" @set-primary="setPrimary" />
